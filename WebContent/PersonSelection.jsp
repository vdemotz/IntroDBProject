...
<h2> <%= request.getParameter(PersonSelectionServlet.EXTERNAL_TITLE_PARAMETER) %> </h2>

<form method="get" action= <%=PersonSelectionServlet.BASE_ADDRESS%> >
<div>
	<input type="hidden" name=<%=PersonSelectionServlet.EXTERNAL_TITLE_PARAMETER%> value =  <%= request.getParameter(PersonSelectionServlet.EXTERNAL_TITLE_PARAMETER) %> >
