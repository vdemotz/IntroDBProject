...
public class SQLCodegen {
	...
	private AttributeMaterializer materializerForAttribute(TableSchema schema, Pair<String, String> identifier) throws SQLSemanticException
	{
		...
		if (index < 0) throw new SQLSemanticException(SQLSemanticException.Type.NoSuchAttributeException, identifier.first + "." + identifier.second + " in table " + schema.toString());
