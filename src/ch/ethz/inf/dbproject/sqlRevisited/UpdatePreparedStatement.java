...
public class UpdatePreparedStatement implements PreparedStatement {

	/**
	 * Create a new PrepareStatement update
	 * @param updateTokensStream
	 */
	UpdatePreparedStatement(ArrayList<SQLToken> updateTokensStream){
